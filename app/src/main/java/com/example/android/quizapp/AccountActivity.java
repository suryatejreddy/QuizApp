...
public class AccountActivity extends AppCompatActivity {
    ...
    @InjectView(R.id.input_name_profile)
    EditText nameEditText;
    @InjectView(R.id.input_email_profile)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("database", "Time: " + Calendar.getInstance().getTimeZone().getDisplayName());

        SimpleDateFormat sdfmad = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        sdfmad.setTimeZone(TimeZone.getTimeZone(Calendar.getInstance().getTimeZone().getID()));
        ...
        if (cursor1.moveToFirst()) {
            while (!cursor1.isAfterLast()) {
                ...
                try {
                    Log.d("database", id + " ," + categ + " ," + score + " ," + outputTime + " ," + pid);
                    cursor1.moveToNext();
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.edit_profile_open) {
            ...
            if (item.getTitle().toString().equals("Edit")) {
                ...
                item.setIcon(getResources().getDrawable(R.drawable.ic_cacel_icon));
                ...
                dobEditText.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        new DatePickerDialog(AccountActivity.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH)).show();
                    }
                });
                ...
                doneButton.setVisibility(View.GONE);
                changePasswordTextView.setVisibility(View.GONE);
                item.setIcon(getResources().getDrawable(R.drawable.ic_edit_profile_grey));
                item.setTitle("Edit");
                return true;
            }
        }
        ...
        if(id==R.id.delete_button){
            ...
            AlertDialog.Builder builder=  new AlertDialog.Builder(AccountActivity.this,R.style.AlertDialogCustomTheme);
            builder
                    .setMessage("Are you sure you want to delete this account and all related data?")
                    .setCancelable(false);
            builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    final ProgressDialog progressDialog= new ProgressDialog(AccountActivity.this, R.style.AppTheme);
                    ...
                    new android.os.Handler().postDelayed(
                            ...
                            new Runnable() {
                                @Override
                                public void run() {
                                    SQLiteDatabase database=(new ProfileDbHelper(getApplicationContext())).getWritableDatabase();
                                    String[] whereArgs=new String[]{String.valueOf(MainActivity.CURRENT_USER_PROFILE_ID)};
                                    int noOfDeletedRowsProfile=database.delete(ProfileContract.ProfileEntry.TABLE_NAME, ProfileContract.ProfileEntry._ID+"=?",whereArgs);

                                    database=(new ScoreDbHelper(getApplicationContext())).getWritableDatabase();
                                    int noOfDeletedRowsScore=database.delete(ScoreContract.ScoreEntry.TABLE_NAME, ScoreContract.ScoreEntry.COLUMN_PLAYER_ID+"=?", whereArgs);
            ...
            new android.os.Handler().postDelayed(
                    ...
                    new Runnable() {
                        ...
                        public void run() {
                            ...
                            menuItem.setIcon(getResources().getDrawable(R.drawable.ic_edit_profile_grey));
                        }
                    },
                    3000
            );
